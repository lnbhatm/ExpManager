...
Public Class Form1
    ...
    Private Sub cmdRpt_Click(sender As Object, e As EventArgs) Handles cmdRpt.Click
        ...
        With worksheetexp
            ...
            For lopidx = 314 To iRow
                If worksheetexp.Cells(lopidx, 6).value = "BANK025" Then
                    worksheetexp.Cells(581, 1).value = "PERSONAL LOAN TAKEN / PERSONAL LOAN RECOVERED"
                    worksheetexp.Cells(inext, 2).value = worksheetexp.Cells(lopidx, 2).value
                    worksheetexp.Cells(inext, 3).value = worksheetexp.Cells(lopidx, 3).value
                    worksheetexp.Cells(inext, 4).value = worksheetexp.Cells(lopidx, 4).value
                    inext = inext + 1
                ElseIf worksheetexp.Cells(lopidx, 7).value = "BANK025" Then
                    worksheetexp.Cells(594, 1).value = "PERSONAL LOAN TAKEN / PERSONAL LOAN RECOVERED"
                    worksheetexp.Cells(inext2, 2).value = worksheetexp.Cells(lopidx, 2).value
                    worksheetexp.Cells(inext2, 3).value = worksheetexp.Cells(lopidx, 3).value
                    worksheetexp.Cells(inext2, 4).value = worksheetexp.Cells(lopidx, 4).value
                    inext2 = inext2 + 1
                End If
            Next
        End With
